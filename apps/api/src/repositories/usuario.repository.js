...
const usuarioRepository = (prisma) => ({
  ...
  findById: (id) =>
    prisma.usuario.findUnique({
      where: { id },
      select: { id: true, nombreCompleto: true, usuario: true, rol: true, sedeId: true, sede: { select: { nombre: true, bodegaId: true } }, activo: true, telefono: true, creadoEn: true, entregadorSedes: { select: { sedeId: true, sede: { select: { nombre: true } } } } },
    }),
